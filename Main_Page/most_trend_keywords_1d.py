...
def most_trend_keywords_1d():
    ...
    headers = {
        ...
        'Referer': 'https://search.shopping.naver.com/best/category/purchase?categoryCategoryId=ALL&categoryChildCategoryId=&categoryDemo=M04&categoryMidCategoryId=&categoryRootCategoryId=ALL&chartRank=1&period=P7D',
    ...
    response = requests.get('https://search.shopping.naver.com/best/_next/data/NurwgmMcJVwLajFklX6sM/category/keyword.json', params=params, cookies=cookies, headers=headers)
