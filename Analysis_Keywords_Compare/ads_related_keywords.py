...
def ads_related_keywords(keyword):
    ...
    keywords_list =  response_json['keywordList']
    ads_related_keywords_list = []
    for ads_related_keywords in keywords_list:
        ads_related_keywords_list.append(ads_related_keywords['relKeyword'])
    
    return ads_related_keywords_list

if __name__ == "__main__" :
    keyword = "마스크"
    ads_related_keywords(keyword)
