...
if __name__ == "__main__" :
    ...
    top_120 = avg_products_purchaseCnt(keyword,120,3)
    top_120_avg_purchaseCnt = sum(top_120)/len(top_120)
    print(top_120)
    print("sum(top_120) :", sum(top_120), "len(top_10 : ", len(top_120) , "top_120_avg_purchaseCnt : ", top_120_avg_purchaseCnt )