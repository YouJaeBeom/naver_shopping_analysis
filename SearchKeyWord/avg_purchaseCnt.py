...
def avg_purchaseCnt(keyword):
    ...
    for data in data_list:
        purchaseCnt_list.append(float(data['purchaseCnt']))

    avg_purchaseCnt = sum(purchaseCnt_list)/len(purchaseCnt_list)

    print(purchaseCnt_list)
    print("sum(purchaseCnt_list) :", sum(purchaseCnt_list), "len(purchaseCnt_list : ", len(purchaseCnt_list) , "avg_price : ", avg_purchaseCnt )

if __name__ == "__main__" :
    keyword="애플워치"
    avg_purchaseCnt(keyword)